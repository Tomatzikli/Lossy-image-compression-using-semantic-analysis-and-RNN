...
class ResNetClassifier(pl.LightningModule):
    ...
    def train_dataloader(self):
        # values here are specific to cifar100 dataset and should be changed for custom data
    ...
    def val_dataloader(self):
        ...
        val_set = CIFAR100(root='./data', train=False,
                                               download=True, transform=transform)
...
if __name__ == "__main__":
    ...
    parser.add_argument("--model",
                        ...
                        type=int, default=50)
    parser.add_argument("--num_classes", help="""Number of classes to be learned.""", type=int, default=100)
    parser.add_argument("--num_epochs", help="""Number of Epochs to Run.""", type=int, default=30)
    parser.add_argument("--train_set", help="""Path to training data folder.""", type=Path, default='./data/cifar100/train')
    parser.add_argument("--vld_set", help="""Path to validation set folder.""", type=Path, default='./data/cifar100/test')
    # Optional arguments
    parser.add_argument("-ts", "--test_set", help="""Optional test set path.""", type=Path, default='./data/cifar100/test')
    ...
    parser.add_argument("-to", "--tune_fc_only", help="Tune only the final, fully connected layers.",
                        action="store_true", default=False)
    parser.add_argument("-s", "--save_path", help="""Path to save model trained model checkpoint.""", default='checkpoint')
    ...
    trainer_args = {'gpus': args.gpus, 'max_epochs': args.num_epochs, 'callbacks': [checkpoint_callback]}
